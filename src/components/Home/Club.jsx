...
const Club = () => {
  return (
    <section className="py-5 md:py-10 container">
      <div className="xs:mx-10 sm:mx-20 md:mx-2 px-2 rounded-2xl bg-gradient-to-r from-[#10B981] to-[#059669] h-auto md:h-32 lg:h-36 shadow-main overflow-hidden">
        <div className="flex items-center justify-center py-4 flex-wrap md:flex-nowrap gap-2 lg:gap-4 h-full w-full">
          <div className="w-full md:w-1/2 flex justify-center items-center gap-2 lg:gap-6">
            <img
              src="/images/club/diamond.png"
              alt="diamond"
              className="w-16 md:w-20 lg:w-24 xl:w-auto"
            />
            <div className="text-white md:space-y-2 w-fit">
              <h4 className="font-MorabbaBold text-2xl lg:text-4xl xl:text-5xl">
                کافی کلاب
              </h4>
              <span className="block font-MorabbaLight text-lg xl:text-2xl w-full">
                میدونستی میتونی با امتیاز هات قهوه بگیری ؟
              </span>
            </div>
          </div>
          <div className="w-full md:w-1/2 flex items-center justify-evenly  md:justify-evenly gap-2  lg:px-5">
            <div className="flex gap-2 md:gap-3 xl:gap-5 items-center child:flex-all child:flex-col child:gap-1.5">
              <div className=" bg-white rounded-2xl w-[74px] h-[74px] lg:w-24 lg:h-24 text-emerald-600 text-xs lg:text-sm">
                <span className="w-8 lg:w-10">
            ...
            <div className="hidden 2xs:flex flex-col text-white">
              <span className="text-xl lg:text-2xl font-DanaMedium leading-5 md:leading-none">
                542
              </span>
              <span className="text-xs xs:text-sm lg:tracking-widest">
                امتیــاز شما
              </span>
              <button className="flex items-center px-1 lg:px-2 py-1.5 rounded-[100px] bg-gradient-to-r from-orange-200 to-orange-300 text-xs lg:text-sm lg:mt-2">
                دریافت جایزه
                <svg
                  fill="none"
                  viewBox="0 0 24 24"
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="hidden xs:block w-4 h-4"
                >
                  <path
                    strokeLinecap="round"
