...
const Shop = () => {
  ...
  return (
    <section>
      <div className="relative bg-shopBg w-full bg-no-repeat bg-cover bg-top min-h-[322px] xs:h-[423px] sm:h-[495px] md:h-[567px] lg:h-screen overflow-hidden md:custom-radius">
        {/* overlay */}
